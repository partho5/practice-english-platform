...
class ContactLink extends Model
{
    ...
    /**
     * Get the user that owns the contact link.
     */
    ...
    /**
     * Get the formatted contact URL.
     */
    public function getContactUrlAttribute(): string
    {
        return match ($this->platform) {
            'facebook' => $this->value,
            'whatsapp' => "https://wa.me/{$this->value}",
            'telegram' => "https://t.me/{$this->value}",
    ...
    /**
     * Scope for public contact links.
     */
